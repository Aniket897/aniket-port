  ...
  return (
    ...
    >
      <div className="w-full  mx-auto bg-transparent dark:bg-transparent group h-full">
        <div className="flex items-center justify-center flex-1 w-full h-full flex-col space-y-5  relative">
          ...
          <div className="flex gap-5 mt-5 items-center justify-center flex-wrap"></div>
        </div>
      </div>
    </Link>
  );
